...
const SurveyPage = () => {
    ...
    const getQuestionTypeId = (type) => {
        switch (type) {
            ...
            case "Шкала": return 4;
            default: throw new Error("Неизвестный тип вопроса.");
        }
    };
    ...
    const addQuestionApi = async (questionnaireId, question) => {
        try {
            ...
            if (["Закрытый", "Множественный выбор"].includes(question.type) && question.answers?.length > 0) {
            ...
            questions.map((q) =>
                q.uniqueId === uniqueId
                    ? {
                        ...
                        type: option,
                        answers:
                            ["Закрытый", "Множественный выбор"].includes(option) &&
                                q.answers.length === 0
                                ? [{ id: `a_${Date.now()}_1`, text: "" }, { id: `a_${Date.now()}_2`, text: "" }]
                                : (["Закрытый", "Множественный выбор"].includes(option) ? q.answers : []),
            ...
            {questions.map((question) => (
                ...
                >
                   <div className="question">
                        ...
                        />
                         {questionErrors[question.displayId] && (questionErrors[question.displayId].includes("Текст вопроса") || (question.type === "Шкала" && questionErrors[question.displayId].includes("Значения шкалы"))) && (
                    ...
                    <div className="action">
                        ...
                        <div className="swap">
                            <button
                                ...
                                disabled={question.displayId === 1 || !!question.animationState} // Disable during animation
                            ...
                            >
                             ...
                             <button
                                ...
                                disabled={question.displayId === questions.filter(q => !q.isDeleting).length || !!question.animationState} // Disable during animation
                        ...
                        <button
                            ...
                            disabled={questions.filter(q => !q.isDeleting).length <= 1 || !!question.animationState} // Disable during animation
